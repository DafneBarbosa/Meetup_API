...
public class RegistrationRepositoryTest {
   ...
   @Test
   @DisplayName("Should return true when registration already created.")
   ...
   @Test
   @DisplayName("Should return false when registration doesn't exists.")
